...
class cameraMainWidget(QtGui.QWidget):
    ...
    def __init__(self, maxSize, parent=None):
        ...
        self.vline2.setValue(maxSize[0] - 1)
        self.hline2.setValue(maxSize[1] - 1)
        self.hline1.setBounds((1, maxSize[1] - 1))
        self.hline2.setBounds((1, maxSize[1] - 1))
        self.vline1.setBounds((1, maxSize[0] - 1))
        self.vline2.setBounds((1, maxSize[0] - 1))
        self.crosshair[0].setBounds((1, maxSize[0] - 1))
        self.crosshair[1].setBounds((1, maxSize[1] - 1))
